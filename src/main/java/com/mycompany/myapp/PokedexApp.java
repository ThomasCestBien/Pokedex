...
public class PokedexApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(PokedexApp.class);

    private final Environment env;

    public PokedexApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PokedexApp.class);
